            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">{{$data['leads_today_house']}}
                                    <p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer ">
                        <hr>
                        <div class="stats">
                            <i class="fa fa-refresh"></i> {{$data['leads_today']}} Publishers
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-stats">
                        ...
                        <div class="row">
                            ...
                            <div class="col-7 col-md-8">
                                <div class="numbers">
                                    ...
                                    <p class="card-title">${{$data['profit_today_house']}}
                                    <p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer ">
                        <hr>
                        <div class="stats">
                            <i class="fa fa-refresh"></i> ${{$data['profit_today']}} Publishers
                        </div>
                    </div>
                </div>
            </div>
