                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:40px; padding-bottom:40px; padding-right: 40px; padding-left: 40px;"><!--<![endif]-->
                                    ...
                                    <div align="center" class="button-container center " style="padding-right: 20px; padding-left: 20px; padding-top:20px; padding-bottom:20px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 20px; padding-left: 20px; padding-top:20px; padding-bottom:20px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$data['link']}}" style="height:49pt; v-text-anchor:middle; width:204pt;" arcsize="76%" strokecolor="{{$data['primary_color']}}" fillcolor="{{$data['primary_color']}}"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#ffffff; font-family:'Oxygen', 'Trebuchet MS', Helvetica, sans-serif; font-size:28px;"><![endif]-->
                                        <a href="{{$data['link']}}" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: {{$data['primary_color']}}; border-radius: 50px; -webkit-border-radius: 50px; -moz-border-radius: 50px; max-width: 272px; width: 212px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 30px; padding-bottom: 5px; padding-left: 30px; font-family: 'Oxygen', 'Trebuchet MS', Helvetica, sans-serif;mso-border-alt: none">
                                            <span style="font-family:'Oxygen', 'Trebuchet MS', Helvetica, sans-serif;font-size:16px;line-height:32px;"><span style="font-size: 15px; line-height: 56px;"><strong> @if($data['price'] == 0) FREE Download @else Download E-Book @endif </strong></span></span>
                                        </a>
                            ...
                            <div style="background-color: #1D1C1C; width: 100% !important;">
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid #FFFFFF; border-left: 6px solid #FFFFFF; border-bottom: 6px solid #FFFFFF; border-right: 6px solid #FFFFFF; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                                    ...
                                    <div align="center" class="button-container center " style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;">
                                        <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-right: 10px; padding-left: 10px; padding-top:10px; padding-bottom:10px;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{$data['link']}}" style="height:28pt; v-text-anchor:middle; width:132pt;" arcsize="61%" strokecolor="#FFFFFF" fillcolor="#FFFFFF"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#343434; font-family:'Oxygen', 'Trebuchet MS', Helvetica, sans-serif; font-size:16px;"><![endif]-->
                                        <a href="{{$data['link']}}" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #343434; background-color: #FFFFFF; border-radius: 23px; -webkit-border-radius: 23px; -moz-border-radius: 23px; max-width: 176px; width: 86px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 45px; padding-bottom: 5px; padding-left: 45px; font-family: 'Oxygen', 'Trebuchet MS', Helvetica, sans-serif;mso-border-alt: none">
