                                ...
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:40px; padding-bottom:40px; padding-right: 40px; padding-left: 40px;"><!--<![endif]-->
                                    ...
                                    <div align="center" class="button-container center " style="padding-right: 20px; padding-left: 20px; padding-top:20px; padding-bottom:20px;">
                                        ...
                                        <a href="{{$data['link']}}" target="_blank" style="display: block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #ffffff; background-color: {{$data['primary_color']}}; border-radius: 50px; -webkit-border-radius: 50px; -moz-border-radius: 50px; max-width: 272px; width: 212px;width: auto; border-top: 0px solid transparent; border-right: 0px solid transparent; border-bottom: 0px solid transparent; border-left: 0px solid transparent; padding-top: 5px; padding-right: 30px; padding-bottom: 5px; padding-left: 30px; font-family: 'Oxygen', 'Trebuchet MS', Helvetica, sans-serif;mso-border-alt: none">
                                            <span style="font-family:'Oxygen', 'Trebuchet MS', Helvetica, sans-serif;font-size:16px;line-height:32px;"><span style="font-size: 22px; line-height: 56px;"><strong> @if($data['price'] == 0) FREE Download @else Download E-Book @endif </strong></span></span>
                                        </a>
